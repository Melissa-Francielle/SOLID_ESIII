/* !!!! FERE OS CONCEITOS DE SINGLE RESPONSIBILITY PRINCIPLE (SRP) !!!!
O código apresenta funcionalidades que não estão relacionadas diretamente com a classe Aluno, 
como verificação de débito e empréstimo de livros.
*/
package src;
